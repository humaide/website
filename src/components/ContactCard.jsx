...
function ContactCard({icon, link, title, content, btn}) {
    return (
        <div className={`w-full h-2/3 lg:h-1/3 flex flex-col items-center justify-center text-charcoal rounded-sm duration-500 transform relative`}> 
            <div className="bg-soft-blue/10 transition-all duration-300 backdrop-blur-xs w-[98%] my-1 p-6 rounded-lg flex flex-col justify-center items-center text-center">
                ...
                <a href={link} target="_blank" className='pt-6 z-20'>
