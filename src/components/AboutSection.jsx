...
function AboutSection() {
  ...
  return (
    <section id="about" className="h-full lg:h-screen w-full flex flex-col text-charcoal bg-charcoal items-center justify-center font-sans px-4 lg:px-16">
      ...
      {/* Cards */}
      <div className="flex flex-col md:flex-row items-center justify-center w-full py-20 gap-6">
        <motion.div  className="w-full md:w-1/3 px-2" custom={0} variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
          <AboutCard illustration="hc" title={t("about.box-title-hcai")} content={t("about.box-content-hcai")} subpageID={0}/>
        </motion.div>

        <motion.div  className="w-full md:w-1/3 px-2" custom={1} variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
          <AboutCard illustration="act" title={t("about.box-title-aiact")} content={t("about.box-content-aiact")} subpageID={1}/>
        </motion.div>

        <motion.div  className="w-full md:w-1/3 px-2" custom={2} variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
